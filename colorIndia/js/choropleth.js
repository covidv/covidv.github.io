	...
	$.fn.choropleth_map = function(data, metadata){
      ...
      function createElements(){
        ...
        //$legend.attr('id', 'legend');
				...
				$legend.html('<strong>Number of cases:</strong><br><p class="key-item" style="background-color:#008000"> Nil</p><p class="key-item" style="background-color:#B0E0E6"> 1 to 5 </p><p class="key-item" style="background-color:#FFD700"> 6 to 20 </p><p class="key-item" style="background-color:#FF4500;color:white"> 21 to 75 </p><p class="key-item" style="background-color:#FF0000;color:white"> 76 to 150 </p><p class="key-item" style="background-color:#8B0000;color:white"> 150+ </p>');
      ...
      function drawMap(){
        ...
        var color = "#feebe2";
				...
				if (c_count > 150) color = "#8B0000";
				else if (c_count > 75 && c_count <= 150) color = "#FF0000";
				else if (c_count > 20 && c_count <= 75 ) color = "#FF4500";
				else if (c_count > 5 && c_count <= 20) color = "#FFD700";
				else if (c_count > 0 && c_count <= 5) color = "#B0E0E6";
				else {color = "#008000";}
